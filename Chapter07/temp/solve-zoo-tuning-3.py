...
KERNEL_BOUND_LOW, KERNEL_BOUND_UP = 0, 1
...
zoo = zoo_tuning_3.ZooTuning(RANDOM_SEED)
...
toolbox.register("individualCreator", tools.initCycle, creator.Individual,
                 (toolbox.attrC, toolbox.attrGamma, toolbox.attrKernel), n=1)
...
toolbox.register("mate", tools.cxSimulatedBinaryBounded, low=[C_BOUND_LOW, GAMMA_BOUND_LOW, KERNEL_BOUND_LOW], up=[C_BOUND_UP, GAMMA_BOUND_UP, KERNEL_BOUND_UP], eta=CROWDING_FACTOR)
toolbox.register("mutate", tools.mutPolynomialBounded, low=[C_BOUND_LOW, GAMMA_BOUND_LOW, KERNEL_BOUND_LOW], up=[C_BOUND_UP, GAMMA_BOUND_UP, KERNEL_BOUND_UP], eta=CROWDING_FACTOR, indpb=1.0/len(zoo))
